...
La Figura \ref{fig:fig_verif_cal_datos} contiene cuatro gráficos de barras que representan los resultados del análisis de la calidad de los datos:
\begin{itemize}
...
La Figura \ref{fig:dag_etl_process} presenta el DAG diseñado para el presente análisis, compuesto por las diferentes tareas:

\begin{itemize}
    \item extraer\_datos\_grupo01: lee y consolida los archivos mensuales de los clientes que tienen mediciones correspondientes a demanda activa y reactiva.
    \item extraer\_datos\_grupo02: lo mismo que la tarea anterior con la diferencia que lo realiza para los clientes que tienen mediciones de energía aparente.
    ...
    \item transformar\_datos\_unificados\: unifica todos los datos a partir de los conjuntos procesados de los dos grupos, lo que da como resultado un DataFrame consolidado de curvas tipo.
...
La Figura \ref{fig:selec_datos} ilustra el flujo de las tareas de extracción y selección de datos dentro del DAG:

\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.34]{./imgs/selec_datos.png}
\caption{{Esquematización de entrada y consolidación de datos}}
\label{fig:selec_datos}
\end{center}
\end{figure}
